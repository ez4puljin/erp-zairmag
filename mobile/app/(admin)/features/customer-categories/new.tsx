...
export default function NewCustomerCategoryScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await api.post('/api/customer-categories', { name: form.name.trim(), type: form.type, description: form.description.trim() || undefined });
  ...
  return (
    <FormModal title="Шинэ бүс нутаг" onSubmit={handleSubmit} submitting={submitting} errorMessage={error}>
