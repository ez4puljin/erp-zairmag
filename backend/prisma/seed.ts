import { PrismaClient, Role, PricingTierLevel, ProductUnit } from '@prisma/client';
...
async function main() {
  ...
  const customer1 = await prisma.customer.create({
    data: {
      ...
      longitude: 106.9177,
      creditLimit: 5000000,
      pricingTier: PricingTierLevel.GOLD,
  ...
  const customer2 = await prisma.customer.create({
    data: {
      ...
      longitude: 106.9054,
      creditLimit: 3000000,
      pricingTier: PricingTierLevel.SILVER,
  ...
  const customer3 = await prisma.customer.create({
    data: {
      ...
      longitude: 106.9167,
      creditLimit: 2000000,
      pricingTier: PricingTierLevel.STANDARD,
  ...
  // ========== TIER PRICES ==========
  // Gold tier gets 10% discount on some products
  await prisma.tierPrice.createMany({
    data: [
      { productId: products[0].id, tier: PricingTierLevel.GOLD, price: 22500 },
      { productId: products[1].id, tier: PricingTierLevel.GOLD, price: 25200 },
      { productId: products[5].id, tier: PricingTierLevel.GOLD, price: 36000 },
      // Silver tier gets 5% discount
      { productId: products[0].id, tier: PricingTierLevel.SILVER, price: 23750 },
      { productId: products[1].id, tier: PricingTierLevel.SILVER, price: 26600 },
    ],
  });
