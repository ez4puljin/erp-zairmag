...
let PaymentsController = class PaymentsController {
    ...
    recordPayment(dto, userId) {
        return this.paymentsService.recordPayment(dto, userId);
    }
    findAll(pagination, customerId, status, method) {
        return this.paymentsService.findAll(pagination, customerId, status, method);
    }
    findByCustomer(id, pagination, user) {
        if (user.role !== client_1.Role.ADMIN && user.customerId !== id) {
...
__decorate([
    (0, common_1.Get)('customers/:id/payments'),
