...
export declare class ReportsController {
    ...
    getDailySales(from: string, to: string, startDate: string, endDate: string): Promise<{
        summary: {
            totalRevenue: number;
            totalOrders: number;
    ...
    getProfitReport(from: string, to: string, startDate: string, endDate: string): Promise<{
        totalRevenue: number;
        totalCost: number;
        grossProfit: number;
        margin: number;
