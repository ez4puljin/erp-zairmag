...
export declare class CustomerCategoriesController {
    private readonly customerCategoriesService;
    constructor(customerCategoriesService: CustomerCategoriesService);
    findAll(): Promise<({
        _count: {
            customers: number;
        };
