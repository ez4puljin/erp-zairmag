...
import { ChevronLeft, Upload, X, RefreshCw, Package, Tag, DollarSign, Boxes, FileText, CheckCircle, Image as ImageIcon } from 'lucide-react';
    ...
    <div className="animate-ios-fade-in">
      <form onSubmit={handleSubmit}>
        ...
        <div className="sticky top-0 z-20 -mx-4 lg:-mx-6 px-4 lg:px-6 py-3 bg-white/90 backdrop-blur-xl border-b border-[#E5E5EA] mb-5 flex items-center gap-3">
          ...
          <h1 className="flex-1 text-[18px] font-bold text-[#1C1C1E] truncate">Засах — {form.name || '...'}</h1>
          <button type="button" onClick={() => router.back()}
